...
@RestController
@RequestMapping("/api/revenu-kafka")
public class RevenuKafkaResource {
    private final Logger log = LoggerFactory.getLogger(RevenuKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RevenuKafkaResource(KafkaProperties kafkaProperties) {
